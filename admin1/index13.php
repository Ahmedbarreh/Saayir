...
<head>
    ...
    <title>Saayir - User Comment</title>
</head>
<body class="bg-dark">
                ...
                <div class="col-lg-6 m-auto">
                    <div class="card mt-5">
                        <div class="card-title">
                             <h3 class="bg-primary text-white text-center py-3"> Add New User Comment</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="insert2.php" method="post">
                                ...
                                <textarea placeholder="message here" class="form-control mb-2" name="message"></textarea>
